...
slope = readgeoraster("slope\slope_NE.tif");
aspect = readgeoraster("Aspect\aspect_NE.tif");
...
aspect = aspect(~isnan(aspect));

%% Wind Rose Plot (Zhongshan Station, NE Region)
...
% Export figure
export_fig('Fig_output\Larsemann_Area1_Rose.png', '-png', '-transparent', '-r800');
...
figure;
set(gcf, 'Units', 'centimeters', 'Position', [15, 10, 10, 15]);
...
% Export figure
export_fig('Fig_output\aspect_pie_chart.png', '-png', '-transparent', '-r800');